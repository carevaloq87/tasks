...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        @if(count($duttiesObjects) == 0)
            <div class="panel-body text-center">
                <h4>No Dutties Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($duttiesObjects as $dutties)
                        <tr>
                            <td>{{ $dutties->name }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('dutties.dutties.show', $dutties->id ) }}" class="btn btn-info" title="Show Dutties">
